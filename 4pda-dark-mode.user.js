      ...
      userConfig = {
          ...
          init() {
              ...
              Object.keys(userConfig.model).forEach((key) => {
                  config[key] = loadedKeys.indexOf(key) >= 0 ? loadedConfig[key] : userConfig.model[key][0]
              });
          ...
          getItem(key) {
              const config = JSON.parse(localStorage.getItem(userConfig.key));
              return config[key]
          },
          setItem(key, value) {
              let jsonString = localStorage.getItem(userConfig.key);
          ...
          shiftItem(key) {
              ...
              const currentIdx = availableValues.indexOf(userConfig.getItem(key));
...
.night .borderwrap p.formbuttonrow, .night .borderwrap p.formbuttonrow1, .night .profile-text, .night .events-popup,
.night form[action*="//4pda.to/forum/index.php"] ul > li, .night .ac_results, .night .footer-nav, .night #footer,
.night form[action*="//4pda.to/forum/index.php"] ul .u-note:after, .night .menu-main-item:hover, .night .menu-sub,
.night .menu-user > a:hover, .night .menu-user:hover > a, .night .menu-user.open > a, .night .plainborder,
.night .tablefill, .night .tablepad, .night .poll-frame, .night .second-menu .menu-brands, .night #events-wrapper,
.night .second-menu .menu-brands li a:hover, .night .second-menu .menu-brands li a:focus, .night .product-detail,
.night #twocolumns, .night .price-slider .ui-slider, .night .comment-box .comment-list li, .night .form-bg,
.night .dipt, .night .bar, .night .barb, .night .barc, .night ul.status, .night .load_frame {
    background: #22272B;
}
...
.night .list-group .list-group-item.active, .night .comment-box .comment-list.level-1 > li, .night .paginator a:hover,
.night .comment-box .comment-list.level-3 > li, .night .comment-box .comment-list.level-5 > li, .night .td-comment,
.night .comment-box .comment-list.level-7 > li, .night .comment-box .comment-list.level-9 > li, .night #print h3,
.night .comment-box .comment-list.level-11 > li, .night #events-list > a:hover, .night .paginator .active a,
.night .td-description, .night .forum-attach-form .forum-attach-file-border, .night .forum-attach-form .view-preview {
    background: #31383e;
}
...
.night #gfooter, .night .ac_over, .night body > div:first-of-type > :nth-child(2) > :first-child > :nth-child(4),
.night .menu-sub-item:hover, .night .menu-sub-item:active, .night .userevents, .night .second-menu .menu-brands li a,
...
.night .dropdown-menu > li > a:focus, .night .forum-attach-form .attach-btn {
    background: #3A4F6C;
}
.night h4 {
...
.night .ed-wrap .ed-vtoggle-down, .night .dropdown-menu .divider, .night .pp-contentbox-back {
...
.night .pagelink, .night .pagelinklast, .night .pagecurrent, .night .minipagelink, .night #t-content .paginator a,
.night .minipagelinklast, .night .hIiDg3yjTi9D > div, .night .maintitlecollapse, .night .qr-maintitle .sel-btn,
...
.night .navbar, .night .paginator span.static {
    border-color: #395179;
}
...
.night .popupmenu-item, .night .maintitle td, .night .maintitle-text, .night .qr-maintitle, .night #gfooter a:visited,
.night #gfooter td, .night #gfooter a:link {
    color: #000;
}
.night a:hover {
    color: #13A4F4;
...
.night .twWqGD1Fem94z0ltz2wnz1 h4, .night .usercp_menu, .night .usercp_menu_out, .night .ed-wrap .ed-vtoggle-normal,
.night .formsubtitle, .night .ed-wrap .ed-vtoggle-hover, .night .ed-wrap .ed-vtoggle-down, .night .ed-wrap .ed-panel {
    color: #3294cf;
}
.night #submenu, .night .ipb-top-left-link a:link, .night .ipb-top-left-link a:visited, .night .upopupmenu-item a:link,
.night .ipb-top-right-link a:link, .night .ipb-top-right-link a:visited, .night .upopupmenu-item-last a:visited,
.night .upopupmenu-item a:visited, .night .upopupmenu-item-last a:link, .night .popmenubutton-new a:visited,
.night .popmenubutton a:link, .night .popmenubutton a:visited, .night .popmenubutton-new a:link, .night .popmenubutton,
.night .popmenubutton-new, .night .popmenubutton a:link, .night .popmenubutton a:visited, .night .globalmesscontent,
.night .popmenubutton-new a:link, .night .popmenubutton-new a:visited {
     color: #515151;
}
...
.night a:link, .night a:visited, .night a:active, .night .advanced-area .post .list-post-title a:visited,
.night .advanced-area .post .list-post-title a, .night .advanced-area .post .list-post-title a:active {
    color: #b2b2b2;
}
.night table.ipbtable, .night tr.ipbtable, .night td.ipbtable, .night body, .night #events-wrapper, .night tr.ipbtable,
.night table.ipbtable, .night td.ipbtable, .night .dipt, .night .maintitle, .night .popupmenu-item-last a:visited,
.night .maintitlecollapse, .night .maintitle a:link, .night .maintitle a:visited, .night .maintitlecollapse a:visited,
.night .maintitlecollapse a:link, .night #navstrip a:link, .night #navstrip a:visited, .night .popmenubutton a:visited,
.night .popupmenu-new, .night .popupmenu-category, .night .popupmenu-item a:link, .night .popupmenu-item-last a:link,
.night .popupmenu-item a:visited, .night .popmenubutton a:link, .night .post-edit-reason, .night .content-box,
.night .advanced-area .post p, .night .content-box blockquote:before {
...
.night button.editor_button, .night .gobutton, .night .catend, .night label.select-field select,
.night .ed-wrap .ed-textarea, .night .comment-box .comment-list {
    color: #DDD;
}
                ...
                function hideApp() {
                    ...
                    for(let i = 0; i < hBut.length; i++) {
                        hBut[i].onclick = function() {
                            const name = this.parentNode.parentNode.children[1].children[1].innerHTML,
                                  ver = this.parentNode.parentNode.children[2].innerHTML;
                            localStorage.setItem(name, ver);
                            // сброс # таблицы и удаление строк(и)
                            _tbl.deleteRow(this.parentNode.parentNode.firstChild.innerHTML);
