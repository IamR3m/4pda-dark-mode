...
if (!localStorage.getItem('4pdafixFlags')) {
    ...
    const jsonString = localStorage.getItem('4pdafixFlags'),
          ...
          loadedKeys = Object.keys(loadedConfig);
      ...
      userConfig = {
          ...
          shiftItem(key) {
              const currentValue = userConfig.getItem(key),
                    availableValues = userConfig.model[key],
                    currentIdx = availableValues.indexOf(currentValue),
                    nextValue = availableValues[(currentIdx + 1) % availableValues.length];
...
.night .popupmenu, .night select, .night .borderwrap, .night .borderwrapm, .night .ed-p-textarea, .night .ed-textarea,
.night .copyright, .night body, .night #logostrip, .night .pagelink, .night .pagelinklast, .night .minipagelink,
.night .minipagelinklast, .night input, .night textarea, .night .post2, .night .post1, .night .bg1, .night .container,
.night .ed-wrap .ed-p-textarea, .night .qr-maintitle, .night .ed-wrap .ed-textarea, .night .side-box, .night .navbar,
.night form[action*="//4pda.to/forum/index.php"] ul .select-field select, .night .footer,  .night .check_list_div,
.night .thread-list .date .text, night form[action*="//4pda.to/forum/index.php"] ul .select-field:before,
.night #ucpmenu, .night #ucpcontent {
    background: #171c20;
}
.night #userlinks, .night #userlinksguest, .night .upopupmenu-new, .night .popupmenu-new, .night #gc_1, .night #go_1,
.night .borderwrap p, .night .row1, .night .row2, .night .post-edit-reason, .night .pformstrip, .night .toplinks span,
.night .borderwrap p.formbuttonrow, .night .borderwrap p.formbuttonrow1, .night .profile-text, .night .ac_results,
.night form[action*="//4pda.to/forum/index.php"] ul > li, .night .footer-nav, .night #footer, .night .menu-sub,
.night form[action*="//4pda.to/forum/index.php"] ul .u-note:after, .night .menu-main-item:hover, .night .events-popup,
.night .menu-user > a:hover, .night .menu-user:hover > a, .night .menu-user.open > a,.night .plainborder, .night .dipt,
.night .tablefill, .night .tablepad, .night .poll-frame, .night .second-menu .menu-brands, .night .product-detail,
.night .second-menu .menu-brands li a:hover, .night .second-menu .menu-brands li a:focus, .night #twocolumns,
.night .price-slider .ui-slider, .night .comment-box .comment-list li, .night .form-bg, .night .bar, .night .barb,
.night .barc, .night #events-wrapper, .night ul.status, .night .load_frame {
    background: #22272B;
}
.night td.formbuttonrow, .night .borderwrap.read .row2, .night .borderwrap.read .post2, .night .post,
.night .borderwrap.read .post1, .night .borderwrap.read td.formbuttonrow, .night .ed-emo-panel div:last-of-type,
...
.night .deletedpost .row2, .night .deletedpost .post1shaded, .night .deletedpost .post2shaded,
...
.night .comment-box .comment-list.level-1 > li, .night .comment-box .comment-list.level-3 > li, .night #print h3,
.night .comment-box .comment-list.level-5 > li, .night .comment-box .comment-list.level-7 > li, .night .td-description
.night .comment-box .comment-list.level-9 > li, .night .comment-box .comment-list.level-11 > li, .night .td-comment
...
.night .borderwrap h3, .night .maintitle, .night .maintitlecollapse, .night .popupmenu-category, .night .catend,
.night .formtable td.formtitle, .night .formsubtitle, .night #gfooter, .night .ac_over, .night .footer-panel,
.night body > div:first-of-type > :nth-child(2) > :first-child > :nth-child(4), .night .menu-sub-item:hover,
.night .menu-sub-item:active, .night .poll-frame .poll-frame-option, .night .second-menu .menu-brands li a,
.night .price-slider .ui-slider .ui-slider-range, .night .comment-box .comment-list .karma .num-wrap,
.night .comment-box .comment-list .karma .num, .night .dropdown-menu > li > a:hover, .night .menu-right #events-count
...
.night .ed-wrap .ed-vtoggle-normal, .night .ed-wrap .ed-vtoggle-hover, .night .ed-wrap .ed-vtoggle-down,
.night .ed-wrap .ed-panel, .night .dropdown-menu .divider, .night .pp-contentbox-back {
    background-color: #3A4F6C;
}
.night .deletedpostlight .row2, .night .deletedpostlight .post1shaded, .night .deletedpostlight .post2shaded,
...
.night .pp-contentbox-entry, .night .pp-contentbox-entry-noheight, .night .pp-contentbox-entry-noheight-mod,
...
.night .popupmenu, .night .popupmenu-new, .night .borderwrap, .night .borderwrapm, .night .upopupmenu, .night .barb,
.night .upopupmenu-new, .night .borderwrap p, .night .bar, .night .barc, .night .toplinks span, .night .subtitlediv,
.night .container, .night .post-block:not(.cur):not(.mod) {
    border-color: #29394e;
}
.night #userlinks, .night #userlinksguest, .night .usercp_menu, .night .usercp_menu_out, .night .post-edit-reason,
.night .pagelink, .night .pagelinklast, .night .pagecurrent, .night .minipagelink, .night .minipagelinklast,
.night .hIiDg3yjTi9D > div, .night .maintitlecollapse, .night form[action*="//4pda.to/forum/index.php"] ul li,
.night form[action*="//4pda.to/forum/index.php"] ul .u-note, .night .profile-text, .night .fosy-div, .night .navbar,
.night form[action*="//4pda.to/forum/index.php"] ul .select-field select, .night .fosy-form input, .night .form-input,
.night .fosy-form textarea, .night .fosy-form select, .night .qr-maintitle .sel-btn, .night .form-input,
.night fieldset, .night #t-content .paginator a, .night .paginator span.static {
    border-color: #395179;
}
...
/* Color */
.night .borderwrap h3, .night #loading-layer-inner, .night .upopupmenu-item, .night .popupmenu-item-last,
.night .popupmenu-item, .night .maintitle td, .night .maintitle-text, .night .qr-maintitle, .night #gfooter td,
.night #gfooter a:link, .night #gfooter a:visited {
    color: #000;
}
.night a:hover {
    color: #13A4F4;
...
.night .globalmesscontent a:link, .night .globalmesscontent a:visited, .night .globalmesscontent a:active,
.night .twWqGD1Fem94z0ltz2wnz1 h4, .night .usercp_menu, .night .usercp_menu_out, .night .formsubtitle,
.night .ed-wrap .ed-vtoggle-normal, .night .ed-wrap .ed-vtoggle-hover, .night .ed-wrap .ed-vtoggle-down,
.night .ed-wrap .ed-panel {
    color: #3294cf;
}
.night #submenu, .night .ipb-top-left-link a:link, .night .ipb-top-left-link a:visited, .night .upopupmenu-item a:link,
.night .ipb-top-right-link a:link, .night .ipb-top-right-link a:visited, .night .upopupmenu-item a:visited,
.night .upopupmenu-item-last a:link, .night .upopupmenu-item-last a:visited, .night .popmenubutton a:link,
.night .popmenubutton a:visited, .night .popmenubutton-new a:link,.night .popmenubutton-new a:visited,
.night .popmenubutton-new, .night .popmenubutton, .night .popmenubutton a:link, .night .popmenubutton a:visited,
.night .popmenubutton-new a:link, .night .popmenubutton-new a:visited, .night .globalmesscontent {
     color: #515151;
}
.night .ed-wrap .ed-panel-title {
    color: #5796fe;
}
.night .content-box a:link, .night .content-box a:visited {
    color: #5c94c8 !important;
}
.night .desc, .night .lastaction {
    color: #5f6772;
}
.night #t-content, .night .wr-t + .footer {
    color: #9e9e9e;
}
.night a:link, .night a:visited, .night a:active, .night .advanced-area .post .list-post-title a,
.night .advanced-area .post .list-post-title a:visited, .night .advanced-area .post .list-post-title a:active {
    color: #b2b2b2;
}
.night table.ipbtable, .night tr.ipbtable, .night td.ipbtable, .night body, .night #events-wrapper, .night tr.ipbtable,
.night table.ipbtable, .night td.ipbtable, .night .dipt, .night .maintitle, .night .maintitlecollapse,
.night .maintitle a:link, .night .maintitle a:visited, .night .maintitlecollapse a:link, .night .popupmenu-item a:link,
.night .maintitlecollapse a:visited, .night #navstrip a:link, .night #navstrip a:visited, .night .popupmenu-new,
.night .popupmenu-category, .night .popupmenu-item a:visited, .night .popupmenu-item-last a:link, .night .content-box,
.night .popupmenu-item-last a:visited, .night .popmenubutton a:link, .night .popmenubutton a:visited,
.night .post-edit-reason, .night .advanced-area .post p, .night .content-box blockquote:before {
    color: #9e9e9e !important;
}
.night .input-warn, .night .input-green, .night .input-checkbox, .night input, .night textarea, .night select,
.night .popupmenu-item-last, .night .textarea, .night .searchinput, .night .button, .night button.editor_button,
.night .gobutton, .night .popupmenu-item, .night .normalname, .night .catend, .night .ed-wrap .ed-textarea,
.night label.select-field select, .night .comment-box .comment-list {
    color: #DDD;
}
...
.night img[alt=">"], .night .popupmenu-item img[alt="V"], .night .popupmenu-item-last img[alt="V"] {
...
.night .dw-fname, .night .dw-fsize, .night .dw-fdwlink, .night .dw-descr, .night body > :nth-child(3) > :last-child {
...
readyHead(() => {
    ...
    window.top === window.self ? document.head.appendChild(userStyleEl) : document.head.appendChild(frameStyleEl)
...
.night #myDiv:hover {
    ...
    color: #9e9e9e;
                      ...
                      styleNode = document.createTextNode(styleData);
                    ...
                    xhr.onload = function() {
                        if (this.readyState === 4 && this.status === 200) {
                            const response = xhr.responseText,
                                  parser = new DOMParser(),
                                  doc = parser.parseFromString(response, 'text/html'),
                                  main = doc.getElementsByClassName('info-list width1 black-link')[0];
        ...
        const fixedButton = "data:image/gif;base64,",
              goButtons = document.getElementsByClassName('gobutton');
